            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 max-w-sm mx-auto">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="font-semibold text-green-700 break-all text-sm">
                    {email}
                  </span>
                </div>
              </div>
              ...
              <p className="text-sm text-gray-600 max-w-sm mx-auto leading-relaxed">
                ...
                <span className="font-semibold text-gray-800 bg-gray-100 px-1.5 py-0.5 rounded">
                  spam
                </span>{" "}
                or{" "}
                <span className="font-semibold text-gray-800 bg-gray-100 px-1.5 py-0.5 rounded">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-slate-700 leading-relaxed">
                    ...
                    protection. You can request a new one anytime from the login
                    page.
                  </p>
                </div>
              </div>
