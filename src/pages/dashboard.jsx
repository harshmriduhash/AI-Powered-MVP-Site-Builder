...
const Dashboard = () => {
  ...
  const handlestripelinking = async () => {
    ...
    try {
      ...
      const createStripeConnectLink = httpsCallable(
        functions,
  ...
  useEffect(() => {
    const checkConnection = async () => {
      ...
      try {
        const checkStripeConnection = httpsCallable(
          functions,
      ...
      <div className="flex">
        ...
        >
          ...
          <nav className="flex-1 px-6 py-6 space-y-2 overflow-y-auto">
            ...
            <div className="mb-8">
              <button
                className="w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-xl bg-gradient-to-r bg-[#46AA72] hover:bg-[hsl(146,42%,57%)] text-white font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                onClick={() => {
                  navigate("/input-idea");
                }}
              >
            ...
            <div className="space-y-1">
              <button
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-50 transition-all duration-200 group ${
                  showProjects
                    ? "text-[#46AA72]"
                    : "text-slate-700 hover:text-[hsl(146,42%,57%)]"
                }`}
                onClick={() => {
                  setShowSubscribers(false);
              ...
              >
                <svg
                  className={`w-5 h-5 transition-colors duration-200 ${
                    showProjects
                      ? "text-[#46AA72]"
                      : "text-slate-400 group-hover:text-[hsl(146,42%,57%)]"
                  }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
        ...
        ${
          stripeloading
            ...
            : "hover:bg-slate-50 hover:text-[#46AA72]"
        }`}
                >
                  <div className="flex items-center space-x-3">
                    {stripeloading ? (
        ...
        ${
          stripeloading
            ? "bg-slate-100 cursor-not-allowed"
            : "hover:bg-slate-50 hover:text-[hsl(146,42%,57%)]"
        }`}
                >
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                      <div className="flex items-center justify-between space-x-2">
                        ...
                        <span
                          className="md:hidden p-2 rounded-md bg-[#90C1CA] text-white cursor-pointer"
                      ...
                      <p className="text-slate-600 max-w-max">
                        Manage your products and track customer{" "}
                ...
                {products.length === 0 ? (
                  <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center max-w-2xl shadow-sm">
                    ...
                    <p className="text-slate-600 mb-8 leading-relaxed">
                      Create your first project to start building your waitlist
                        ...
                        >
                          ...
                          <div className="p-6 border-b border-slate-100 flex-shrink-0">
                            <div className="flex justify-between">
                              <Link
                                to={`/${username}/${encodeURIComponent(
                                  product.productName
                                )}`}
                                className="block"
                              >
                            ...
                            <div className="flex items-center gap-2 p-3 bg-slate-50 rounded-xl">
                              ...
                              />
                              <a
                                href={`https://bloomqueue.com/${encodeURIComponent(
                                  username
                              ...
                              <button
                                onClick={() =>
                                  handleCopy(
                                    `https://bloomqueue.com/${encodeURIComponent(
                                      username
                                    )}/${encodeURIComponent(
                                      product.productName
                                    )}`,
